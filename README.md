...
## What I did:
- Received raw, unclean sensor data from field scientists
- Cleaned and organized the data programmatically
- Generated an interactive HTML visualization for technical and non-technical stakeholders to explore time series data by location

## Tools used: 
R, R Markdown

## Live report: 
https://taylorjgill.github.io/NCRMP-Time-Series-Data/
